...
const Payment = () => {
    ...
    const placeOrder = async (paymentInfo) => {
        if (!order?.cart?.length || !order?.shippingAddress || !order?.totalPrice) {
    ...
    const paymentHandler = async (e) => {
        ...
        try {
            if (!stripe || !elements) {
                toast.error("Card payment is unavailable. Please use Cash on Delivery.");
                return;
            }
            ...
            <div className="w-[90%] 1000px:w-[70%] block 800px:flex">
                <div className="w-full 800px:w-[65%]">
                    <PaymentInfo
                        ...
                        cardEnabled={Boolean(stripe && elements)}
                    />
                </div>
    ...
    return (
        <div className="w-full 800px:w-[95%] bg-[#fff] rounded-md p-5 pb-8">
            ...
            <div>
                ...
                {!cardEnabled && (
                    <p className="text-[14px] text-[#f63b60] pb-3">
                        Card payment is unavailable. Please use Paypal or Cash on Delivery.
                    </p>
                )}
